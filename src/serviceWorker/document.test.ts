...
describe('document', () => {
  describe('matchDocument', () => {
    const TEST_DOCUMENTS = [
      ...
      [{ request: {}, url: { hostname: 'app.animeswap.org', pathname: '' } }, false],
      [{ request: { mode: 'navigate' }, url: { hostname: 'app.animeswap.org', pathname: '' } }, true],
      [{ request: { mode: 'navigate' }, url: { hostname: 'app.animeswap.org', pathname: '/#/swap' } }, true],
      [{ request: { mode: 'navigate' }, url: { hostname: 'app.animeswap.org', pathname: '/asset.gif' } }, false],
